...
var fast = new Promise(resolve => setTimeout(() => resolve('fast'), 50));
var slow = new Promise(resolve => setTimeout(() => resolve('slow'), 100));
...
var willResolve = new Promise(resolve => setTimeout(() => resolve('ok'), 100));
var willReject = new Promise((_, reject) => setTimeout(() => reject(new Error('fail')), 50));
