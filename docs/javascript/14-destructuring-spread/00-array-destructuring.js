/**
 * TOPIC: Array Destructuring Basics
 *
 * STORY: Imagine you order a combo meal - burger, fries, drink. Instead of
 * reaching into the bag each time (bag[0], bag[1], bag[2]), destructuring
 * is like the cashier handing each item directly to your left hand, right
 * hand, and the table. Each item goes to its assigned spot by POSITION.
 *
 * ╔════════════════════════════════════════════════════════════════════════════╗
 * ║ THE GOLDEN RULE                                                            ║
 * ╠════════════════════════════════════════════════════════════════════════════╣
