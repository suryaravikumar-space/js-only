 ...
 * INTERVIEW QUESTION:
 *
 * Q: "What does this code output? var a = 10; function outer() { console.log(a);
 *     console.log(b); var a = 20; let b = 30; } outer();"
 * A: First `console.log(a)` prints `undefined` — the local `var a` is hoisted and
 *    shadows the global `a = 10`. Second `console.log(b)` throws ReferenceError
 *    because `let b` is in the TDZ. Everything after the error never runs.
 *    Key concepts tested: var hoisting, let TDZ, scope shadowing, error propagation.
 *
 * RUN: node docs/javascript/01-execution-context/13-combined-tricky.js
 */
