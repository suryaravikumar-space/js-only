...
const inconsistentAPI = (cached, callback) => {
  if (cached) {
...
inconsistentAPI(true, (result) => {
  console.log('B:', result);
});
console.log('B:', 'After');

// Problem 4: Error handling - callback might throw
const riskyOperation = (callback) => {
  try {
    callback(null, 'data');
  } catch (e) {
