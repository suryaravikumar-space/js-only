 ...
 *
 * STORY: Think of an iterator like a BOOKMARK in a book. The book (iterable)
 * has many pages (values). The bookmark (iterator) remembers where you are.
 * Each time you call next(), you turn to the next page. When you reach the
 * end, done becomes true — the book is finished!
 *
 * ╔════════════════════════════════════════════════════════════════════════════╗
 * ║ THE GOLDEN RULE                                                            ║
 * ╠════════════════════════════════════════════════════════════════════════════╣
