...
constoriginal = new Promise(resolve => setTimeout(() => resolve('original'), 10));
constwrapped = Promise.resolve(original);
...
constrejected = Promise.reject(new Error('oops'));
