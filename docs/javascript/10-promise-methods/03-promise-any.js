...
constp1 = new Promise((_, reject) => setTimeout(() => reject('err1'), 50));
constp2 = new Promise(resolve => setTimeout(() => resolve('success'), 100));
constp3 = new Promise((_, reject) => setTimeout(() => reject('err2'), 150));
