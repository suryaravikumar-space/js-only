 ...
 * ├────────────────────────────────────────────────────────────────┤
 * │                                                                │
 * │ "In non-strict mode, calling a function standalone sets       │
 * │  `this` to the global object. In strict mode, `this` is       │
 * │  `undefined` for standalone calls. This is a safety feature   │
 * │  that prevents accidental modification of the global object.  │
 * │                                                                │
 * │  Note that strict mode doesn't prevent access to global       │
 * │  variables through the scope chain — it only affects what     │
 * │  `this` points to. ES6 modules and classes are strict by      │
 * │  default, so most modern code runs in strict mode."           │
 * │                                                                │
 * └────────────────────────────────────────────────────────────────┘
 *
 *
 * RUN: node docs/01-execution-context/16-strict-mode-this.js
 */
