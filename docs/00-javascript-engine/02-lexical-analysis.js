 ...
 * ╠════════════════════════════════════════════════════════════════════════════╣
 * ║                                                                            ║
 * ║ The LEXER (Scanner/Tokenizer) is the FIRST stage of compilation.           ║
 * ║ It reads source code CHARACTER BY CHARACTER and groups them into           ║
 * ║ meaningful chunks called TOKENS - the smallest units of meaning.           ║
 * ║                                                                            ║
 * ║ Think of it like this:                                                     ║
 * ║   - Source code is like a sentence: "The quick brown fox"                  ║
 * ║   - Tokens are like words: ["The", "quick", "brown", "fox"]                ║
 * ║                                                                            ║
...
function createLexer(sourceCode) {
  ...
  function readNumber() {
    ...
    if (peek() === '0' && peek(1)) {
      var nextChar = peek(1).toLowerCase();
      if (nextChar === 'x') {
  ...
  function readOperator() {
    ...
    for (var i = 0; i < multiCharOperators.length; i++) {
      var op = multiCharOperators[i];
      var match = true;
      ...
      if (match) {
        for (var k = 0; k < op.length; k++) advance();
        return op;
      }
    }
...
function formatTokens(tokens) {
  return tokens.map(function(t) {
    return t.type.padEnd(12) + ' │ ' + String(t.value).padEnd(15) + ' │ L' + t.line + ':C' + t.column;
  }).join('\n');
}
...
console.log('═'.repeat(70));
var code2 = 'function greet(name) { return "Hello " + name; }';
console.log('Input: "' + code2 + '"');
console.log('─'.repeat(70));
var tokens2 = createLexer(code2);
...
console.log('═'.repeat(70));
console.log('TEST C: All Number Formats');
console.log('═'.repeat(70));
var code3 = 'var decimal = 42; var hex = 0xFF; var octal = 0o77; var binary = 0b1010; var bigint = 123n; var float = 3.14; var scientific = 1e10;';
console.log('Input:', code3.substring(0, 50) + '...');
console.log('─'.repeat(70));
var tokens3 = createLexer(code3);
...
console.log('═'.repeat(70));
var code4 = 'a == b; a === b; a != b; a !== b; a < b; a > b; a <= b; a >= b;';
console.log('Input: "' + code4 + '"');
console.log('─'.repeat(70));
var tokens4 = createLexer(code4);
console.log('Operators found:', tokens4.filter(t => t.type === 'OPERATOR').map(t => t.value).join(', '));
console.log();

console.log('═'.repeat(70));
console.log('TEST E: Modern JavaScript Features');
console.log('═'.repeat(70));
var code5 = 'const fn = async () => { await fetch(); }; const x = obj?.prop ?? default;';
console.log('Input: "' + code5 + '"');
console.log('─'.repeat(70));
var tokens5 = createLexer(code5);
...
console.log('═'.repeat(70));
var code6 = 'var msg = "Hello\\nWorld\\tTab";';
console.log('Input: "' + code6 + '"');
console.log('─'.repeat(70));
var tokens6 = createLexer(code6);
 ...
 *
 * ╔════════════════════════════════════════════════════════════════════════════╗
 * ║ INTERVIEW QUESTION: What's the difference between Lexer and Parser?        ║
 * ╠════════════════════════════════════════════════════════════════════════════╣
 * ║                                                                            ║
